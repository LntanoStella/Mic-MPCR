...
from mic_geotrans.modules.ops import point_to_node_partition, index_select
from mic_geotrans.modules.registration import get_node_correspondences
from mic_geotrans.modules.sinkhorn import LearnableLogOptimalTransport
from mic_geotrans.modules.geotransformer import (
...
class GeoTransformer(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        # 6. Select topk nearest node correspondences - 使用torch.no_grad()减少内存使用
        with torch.no_grad():
